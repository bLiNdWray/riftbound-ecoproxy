(function() {
  ...
  const container = document.getElementById('card-container');
  if (!container) {
    console.error('ui.js: #card-container not found—aborting initialization.');
    return;
  }
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // — Wrap addCard/removeCard to sync cardCounts —
    ...
    // — Observe DOM mutations for live updates —
    ...
    // — Wire +/- buttons in Overview modal —
    ...
    // — Build & display the Overview modal —
    ...
    btnFullProxy.addEventListener('click', () => {
      fullProxy = !fullProxy;
      // TODO: add your fullProxy toggle logic here
    });
